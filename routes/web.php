...
Route::group(['middleware' => ['auth', 'web']], function(){
    ...
    Route::group(['middleware' => ['cekuser:1']], function () {
        Route::group(['prefix' => 'report', 'as' => 'report.'], function() {
            Route::get('penjualan/toCSV', 'Report\ReportPenjualanController@exportCSV')->name('penjualan.tocsv');
            Route::post('penjualan/toPDF', 'Report\ReportPenjualanController@exportToPDF')->name('penjualan.topdf');
